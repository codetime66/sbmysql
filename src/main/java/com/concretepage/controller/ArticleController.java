...
import com.concretepage.entity.Shirtb;
...
//                   Set shirts = person.getShirts();
            //                 Iterator itr = shirts.iterator();
            //               while(itr.hasNext()){
            //                 Shirt shirt = (Shirt)itr.next();
    ...
    public ResponseEntity<List<Person>> getPersonShirst() {
        ...
        for (int i = 0; i < list_.size(); i++) {
            ...
            if (row[1] instanceof Shirtb) {
                Shirtb shirt = (Shirtb) row[1];
                System.out.println("CompId:" + person.getId() + ", CompName:" + person.getName()
                        + ", EmpId:" + shirt.getId() + ", EmpName:" + shirt.getColor());
            }            
        }
